...
/**
 * Filter for grid string columns 
 *
 */
public class StringFilter extends GridStringFilter {
	private Column _col;
	private StringFilterClause _clause;

	/**
	 * @param col
	 *            the column for which filter will be defined
	 * @param clause
	 *            the string filter clause
	 */
	public StringFilter( Column col, StringFilterClause clause ) {
		super( col.getName( ) );
		_col = col;
		_clause = clause;
	}
