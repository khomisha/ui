...
/**
 * Filter for grid numeric columns
 *
 */
public class NumericFilter extends GridNumericFilter {
	private Column _col;
	private NumericFilterClause _clause;

	/**
	 * @param col
	 *            the column for which filter will be defined
	 * @param clause
	 *            the numeric filter clause
	 */
	public NumericFilter( Column col, NumericFilterClause clause ) {
		super( col.getName( ) );
		_col = col;
		_clause = clause;
	}
