...
/**
 * Numeric filter clause
 *
 */
public class NumericFilterClause extends FilterClause {
	
	public NumericFilterClause( ) {
		List< NameValuePair > operators = getOperators( );
		operators.add( new NameValuePair( "gt", " < " ) ); 
		operators.add( new NameValuePair( "lt", " > " ) ); 
		operators.add( new NameValuePair( "eq", " = " ) ); 				
	}
